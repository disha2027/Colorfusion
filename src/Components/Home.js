      ...
      <div className='container'>
        <div className='row'>
          <div className='first'>
            ...
            {/* <h6>Cosmetics designed for skin care can be used to cleanse, exfoliate and protect the skin, as well as replinishing it by the use of cleansers,toners,serums etc.</h6> */}
          </div>
        </div>
      </div>
      ...
      <div className='container m-5'>
            ...
            <div className="carousel-inner">
                  ...
                  <div className="carousel-item active">
                      <img src={logo2}  alt="Not Found" height={346} width={1050} className="d-block mx-4"/>
                  </div>
     
                  <div className="carousel-item">
                      <img src={lg2} alt="Not Found"  height={346} width={1050} className="d-block mx-4"/>
                  </div>

                  <div className="carousel-item">
                      <img src={lg3} alt="Not Found"  height={346} width={1050} className="d-block mx-4"/>
                  </div>
            </div>
